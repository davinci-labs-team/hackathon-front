    ...
    <v-card>
      ...
      <v-card-text>
        <v-form @submit.prevent="onSubmit">
          <!-- Nom -->
          <label class="block mb-1 text-m">{{ t('partnersSettings.nameTitle') }}</label>
          <v-text-field
            v-model="name"
          ...
          <!-- Website -->
          <label class="block mb-1 text-m">{{ t('partnersSettings.websiteTitle') }}</label>
          <v-text-field
            v-model="websiteUrl"
          ...
          <!-- Logo -->
          <label class="block mb-1 text-m">{{ t('partnersSettings.logo') }}</label>
          <v-file-input
          v-model="fileModel"
