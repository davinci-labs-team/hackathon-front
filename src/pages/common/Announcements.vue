    ...
    if (editMode.value && selectedAnnouncement.value) {
      ...
      try {
        const updated = await AnnouncementService.update(
          ...
          data as UpdateAnnouncementDTO
        )
        const index = allAnnouncements.value.findIndex(
    ...
    <v-row justify="center" class="mt-8">
      <div class="w-full md:w-8/12 lg:w-9/12 px-4">
        ...
        <div class="flex mb-4 gap-4 items-center">
          ...
          />
          <v-btn color="primary" @click="onAddAnnouncement" v-if="canManageAnnouncements">
        ...
        <Announcements
          ...
          :items-per-page="5"
          :can-delete="canManageAnnouncements"
          :can-edit="canManageAnnouncements"
