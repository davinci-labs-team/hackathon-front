  ...
  <v-container class="py-12 max-w-3xl mx-auto">
    ...
    <p>
      {{
        ...
        'We collect information necessary for the proper functioning of our services.'
      }}
    </p>

    <h2 class="text-xl font-semibold mt-6 mb-2">
      {{ t('privacy.section2') || '2. How We Use Information' }}
    </h2>
    <p>
      {{
        t('privacy.section2_text') ||
        'Your data is used to improve our services and ensure a better user experience.'
      }}
    </p>
