...
export const announcements: Announcement[] = [
  {
    ...
    author: 'Paul Martin',
    publishedDate: getPastDate(30 * 1000), // 30 secondes
    tags: ['2025', 'Public'],
    description:
  ...
  },
  {
    ...
    author: 'Paul Martin',
    publishedDate: getPastDate(5 * 60 * 1000), // 5 minutes
    tags: ['2025'],
    description:
  ...
  },
  {
    ...
    publishedDate: getPastDate(3 * 60 * 60 * 1000), // 3 heures
    tags: ['2025'],
    description:
  ...
  },
  {
    ...
    author: 'Paul Martin',
    publishedDate: getPastDate(2 * 24 * 60 * 60 * 1000), // 2 jours
    tags: ['2025', 'Sponsors'],
    description:
  ...
  },
  {
    ...
    author: 'Jean Dupont',
    publishedDate: getPastDate(3 * 7 * 24 * 60 * 60 * 1000), // 3 semaines
    tags: ['2025', 'Infos'],
    description:
  ...
  },
  {
    ...
    author: 'Marie Curie',
    publishedDate: getPastDate(5 * 7 * 24 * 60 * 60 * 1000), // 5 semaines
    tags: ['2025'],
    description:
  ...
  },
  {
    ...
    author: 'Paul Martin',
    publishedDate: getPastDate(6 * 7 * 24 * 60 * 60 * 1000), // 6 semaines
    tags: ['2025', 'Événement'],
    description:
  ...
  },
  {
    ...
    author: 'Sarah Leblanc',
    publishedDate: getPastDate(8 * 7 * 24 * 60 * 60 * 1000), // 8 semaines
