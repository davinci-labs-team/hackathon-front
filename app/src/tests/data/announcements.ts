...
export const announcements: AnnouncementDTO[] = [
  {
    ...
    author: 'Paul Martin',
    createdAt: getPastDate(30 * 1000), // 30 secondes
    tags: ['2025', 'Public'],
    description:
  ...
  },
  {
    ...
    author: 'Paul Martin',
    createdAt: getPastDate(5 * 60 * 1000), // 5 minutes
    tags: ['2025'],
    description:
  ...
  },
  {
    ...
    createdAt: getPastDate(3 * 60 * 60 * 1000), // 3 heures
    tags: ['2025'],
    description:
  ...
  },
  {
    ...
    author: 'Paul Martin',
    createdAt: getPastDate(2 * 24 * 60 * 60 * 1000), // 2 jours
    tags: ['2025', 'Sponsors'],
    description:
    ...
    isPrivate: false,
    existingImages: [exampleImg, epitaLogo],
  },
  {
    title: 'Annonce spéciale 1',
    author: 'Jean Dupont',
    createdAt: getPastDate(3 * 7 * 24 * 60 * 60 * 1000), // 3 semaines
    tags: ['2025', 'Infos'],
    description:
  ...
  },
  {
    ...
    author: 'Marie Curie',
    createdAt: getPastDate(5 * 7 * 24 * 60 * 60 * 1000), // 5 semaines
    tags: ['2025'],
    description:
  ...
  },
  {
    ...
    author: 'Paul Martin',
    createdAt: getPastDate(6 * 7 * 24 * 60 * 60 * 1000), // 6 semaines
    tags: ['2025', 'Événement'],
    description:
  ...
  },
  {
    ...
    author: 'Sarah Leblanc',
    createdAt: getPastDate(8 * 7 * 24 * 60 * 60 * 1000), // 8 semaines
