export default {
  ...
  themes: {
    title: 'Thèmes & Sujets',
    subtitle: 'Gérez les thèmes et sujets proposés pour le hackathon',
    themesManagement: 'Gestion des Thèmes',
    subjectsManagement: 'Gestion des Sujets',
    themeName: 'Nom du Thème',
    themeDescription: 'Description du Thème',
    subjectName: 'Nom du Sujet',
    subjectDescription: 'Description du Sujet',
    associatedThemes: 'Thèmes Associés',
    addThemeBtn: '+ Ajouter un thème',
    addSubjectBtn: '+ Ajouter un sujet',
    addTheme: 'Nouveau thème',
    addSubject: 'Nouveau sujet',
    editTheme: 'Modifier le thème',
    editSubject: 'Modifier le sujet',
    deleteTheme: 'Supprimer le thème',
    deleteSubject: 'Supprimer le sujet',
    confirmTitleTheme: 'Confirmer la suppression du thème',
    confirmTextTheme:
      'Vous allez supprimer ce thème : {themeName}. Cela supprimera également ce thème de tous les sujets associés.',
    confirmTitleSubject: 'Confirmer la suppression du sujet',
    confirmTextSubject: 'Vous allez supprimer ce sujet : {subjectName}',
