export default {
  ...
  matchmakingSettings: {
    ...
    addCriterionBtn: '+ Ajouter un critère',
    addCriterion: 'Nouveau critère',
    ...
    confirmTitle: 'Confirmer la suppression',
    confirmText: 'Êtes-vous sûr de vouloir supprimer ce critère ?',
    noCriteria: 'Aucun critère disponible.',
    errors: {
